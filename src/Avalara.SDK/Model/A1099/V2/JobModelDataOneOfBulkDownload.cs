...
{
/// <summary>
    /// JobModelDataOneOfBulkDownload
    /// </summary>
    [DataContract(Name = "JobModel_data_oneOf_bulkDownload")]
    public partial class JobModelDataOneOfBulkDownload : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobModelDataOneOfBulkDownload" /> class.
        /// </summary>
        /// <param name="downloadUrl">downloadUrl.</param>
        public JobModelDataOneOfBulkDownload(string downloadUrl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JobModelDataOneOfBulkDownload {\n");
