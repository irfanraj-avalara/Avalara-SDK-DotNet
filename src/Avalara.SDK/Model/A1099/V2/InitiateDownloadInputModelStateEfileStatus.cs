...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "InitiateDownloadInputModel_stateEfileStatus")]
    public partial class InitiateDownloadInputModelStateEfileStatus : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InitiateDownloadInputModelStateEfileStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">status.</param>
        public InitiateDownloadInputModelStateEfileStatus(DateTime date = default(DateTime), string status = default(string))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InitiateDownloadInputModelStateEfileStatus {\n");
