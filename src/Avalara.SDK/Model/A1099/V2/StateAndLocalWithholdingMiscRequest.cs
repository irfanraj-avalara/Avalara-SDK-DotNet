...
{
/// <summary>
    /// StateAndLocalWithholdingMiscRequest
    /// </summary>
    [DataContract(Name = "StateAndLocalWithholdingMiscRequest")]
    public partial class StateAndLocalWithholdingMiscRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StateAndLocalWithholdingMiscRequest" /> class.
        /// </summary>
        /// <param name="stateTaxWithheld">stateTaxWithheld.</param>
        /// <param name="localTaxWithheld">localTaxWithheld.</param>
        /// <param name="state">state.</param>
        /// <param name="payerStateIdNumber">payerStateIdNumber.</param>
        /// <param name="locality">locality.</param>
        /// <param name="stateIncome">stateIncome.</param>
        /// <param name="localIncome">localIncome.</param>
        public StateAndLocalWithholdingMiscRequest(double stateTaxWithheld = default(double), double localTaxWithheld = default(double), string state = default(string), string payerStateIdNumber = default(string), string locality = default(string), double stateIncome = default(double), double localIncome = default(double))
        {
            this.StateTaxWithheld = stateTaxWithheld;
            this.LocalTaxWithheld = localTaxWithheld;
            this.State = state;
            this.PayerStateIdNumber = payerStateIdNumber;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StateAndLocalWithholdingMiscRequest {\n");
            ...
            sb.Append("  PayerStateIdNumber: ").Append(PayerStateIdNumber).Append("\n");
