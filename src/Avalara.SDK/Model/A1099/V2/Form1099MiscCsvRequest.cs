...
{
/// <summary>
    /// Form1099MiscCsvRequest
    /// </summary>
    [DataContract(Name = "Form1099MiscCsvRequest")]
    public partial class Form1099MiscCsvRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Form1099MiscCsvRequest" /> class.
        /// </summary>
        ...
        public Form1099MiscCsvRequest(StateAndLocalWithholdingMiscRequest stateAndLocalWithholding = default(StateAndLocalWithholdingMiscRequest), bool secondTinNotice = default(bool), double rents = default(double), double royalties = default(double), double otherIncome = default(double), double fedIncomeTaxWithheld = default(double), double fishingBoatProceeds = default(double), double medicalHealthCarePayments = default(double), bool payerMadeDirectSales = default(bool), double substitutePayments = default(double), double cropInsuranceProceeds = default(double), double grossProceedsPaidToAttorney = default(double), double fishPurchasedForResale = default(double), double section409ADeferrals = default(double), bool fatcaFilingRequirement = default(bool), double excessGoldenParachutePayments = default(double), double nonqualifiedDeferredCompensation = default(double), string type = default(string), string issuerId = default(string), string issuerReferenceId = default(string), string issuerTin = default(string), int taxYear = default(int), string referenceId = default(string), string recipientName = default(string), string recipientFederalId = default(string), int federalIdType = default(int), string recipientSecondName = default(string), string streetAddress = default(string), string streetAddressLine2 = default(string), string city = default(string), string state = default(string), string zip = default(string), string foreignAddress = default(string), string recipientEmail = default(string), string accountNumber = default(string), string officeCode = default(string), string recipientNonUsProvince = default(string), string countryCode = default(string))
        {
        ...
        public StateAndLocalWithholdingMiscRequest StateAndLocalWithholding { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "recipientFederalId", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Form1099MiscCsvRequest {\n");
