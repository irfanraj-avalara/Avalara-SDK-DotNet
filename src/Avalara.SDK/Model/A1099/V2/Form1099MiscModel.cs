...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "Form1099MiscModel")]
    public partial class Form1099MiscModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Form1099MiscModel" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected Form1099MiscModel() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="Form1099MiscModel" /> class.
        /// </summary>
        /// <param name="type">type.</param>
        /// <param name="rents">Amount of rents..</param>
        /// <param name="royalties">Amount of royalties..</param>
        /// <param name="otherIncome">Amount of other income..</param>
        /// <param name="fedIncomeTaxWithheld">Amount of federal income tax withheld..</param>
        /// <param name="fishingBoatProceeds">Proceeds from fishing boats..</param>
        /// <param name="medicalAndHealthCare">Amount of medical and healthcare payments..</param>
        /// <param name="forResale">Indicates whether the payment is for resale purposes..</param>
        /// <param name="substitutePayments">Amount of substitute payments..</param>
        /// <param name="cropInsuranceProceeds">Crop insurance proceeds..</param>
        /// <param name="grossProceedsPaidToAnAttorney">Gross proceeds paid to an attorney..</param>
        /// <param name="fishPurchasedForResale">Amount of fish purchased for resale..</param>
        /// <param name="section409aDeferrals">Section 409A deferrals..</param>
        /// <param name="fatcaFilingReqt">FATCA filing requirement indicator..</param>
        /// <param name="excessGoldenParachutePayments">Excess golden parachute payments..</param>
        ...
        public Form1099MiscModel(Object type = default(Object), double rents = default(double), double royalties = default(double), double otherIncome = default(double), double fedIncomeTaxWithheld = default(double), double fishingBoatProceeds = default(double), double medicalAndHealthCare = default(double), string forResale = default(string), double substitutePayments = default(double), double cropInsuranceProceeds = default(double), double grossProceedsPaidToAnAttorney = default(double), double fishPurchasedForResale = default(double), double? section409aDeferrals = default(double?), string fatcaFilingReqt = default(string), double excessGoldenParachutePayments = default(double), double? nonqualifiedDeferredCompensation = default(double?), StateWithholding stateWithholding = default(StateWithholding), string issuerId = default(string), string issuerReferenceId = default(string), string issuerTin = default(string), int taxYear = default(int), bool federalEfile = default(bool), Form1099BaseModelFederalEfileStatus federalEfileStatus = default(Form1099BaseModelFederalEfileStatus), bool postalMail = default(bool), Form1099BaseModelPostalMailStatus postalMailStatus = default(Form1099BaseModelPostalMailStatus), bool stateEfile = default(bool), List<StateEfileStatusesInner> stateEfileStatuses = default(List<StateEfileStatusesInner>), bool tinMatch = default(bool), TinMatchStatus tinMatchStatus = default(TinMatchStatus), bool addressVerification = default(bool), AddressVerificationStatus addressVerificationStatus = default(AddressVerificationStatus), string referenceId = default(string), string recipientName = default(string), string federalIdType = default(string), string recipientFederalIdNo = default(string), string recipientSecondName = default(string), string streetAddress = default(string), string streetAddressLine2 = default(string), string city = default(string), string state = default(string), string zip = default(string), string foreignProvince = default(string), string countryCode = default(string), string recipientEmail = default(string), string acctNo = default(string), string officeCode = default(string))
        {
            ...
            this.FatcaFilingReqt = fatcaFilingReqt;
        ...
        /// Amount of royalties.
        /// </summary>
        /// <value>Amount of royalties.</value>
        /// <example>0.0</example>
        ...
        /// </summary>
        /// <value>Amount of other income.</value>
        /// <example>0.0</example>
        ...
        /// </summary>
        /// <value>Amount of federal income tax withheld.</value>
        /// <example>0.0</example>
        ...
        /// </summary>
        /// <value>Proceeds from fishing boats.</value>
        /// <example>0.0</example>
        [DataMember(Name = "fishingBoatProceeds", EmitDefaultValue = false)]
        public double FishingBoatProceeds { get; set; }

        /// <summary>
        /// Amount of medical and healthcare payments.
        /// </summary>
        /// <value>Amount of medical and healthcare payments.</value>
        /// <example>0.0</example>
        [DataMember(Name = "medicalAndHealthCare", EmitDefaultValue = false)]
        public double MedicalAndHealthCare { get; set; }

        /// <summary>
        /// Indicates whether the payment is for resale purposes.
        /// </summary>
        /// <value>Indicates whether the payment is for resale purposes.</value>
        [DataMember(Name = "forResale", EmitDefaultValue = false)]
        public string ForResale { get; set; }

        /// <summary>
        /// Amount of substitute payments.
        /// </summary>
        /// <value>Amount of substitute payments.</value>
        /// <example>0.0</example>
        ...
        [DataMember(Name = "grossProceedsPaidToAnAttorney", EmitDefaultValue = false)]
        public double GrossProceedsPaidToAnAttorney { get; set; }

        /// <summary>
        /// Amount of fish purchased for resale.
        /// </summary>
        /// <value>Amount of fish purchased for resale.</value>
        /// <example>0.0</example>
        ...
        /// </summary>
        /// <value>FATCA filing requirement indicator.</value>
        [DataMember(Name = "fatcaFilingReqt", EmitDefaultValue = false)]
        public string FatcaFilingReqt { get; set; }

        /// <summary>
        /// Excess golden parachute payments.
        /// </summary>
        /// <value>Excess golden parachute payments.</value>
        /// <example>0.0</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Form1099MiscModel {\n");
