...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "postalMailStatus")]
    public partial class PostalMailStatus : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostalMailStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">status.</param>
        public PostalMailStatus(DateTime date = default(DateTime), StatusEnum? status = default(StatusEnum?))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostalMailStatus {\n");
