...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "PaginatedQueryResultModel_IssuerModel")]
    public partial class PaginatedQueryResultModelIssuerModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedQueryResultModelIssuerModel" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="value">value.</param>
        /// <param name="nextLink">nextLink.</param>
        public PaginatedQueryResultModelIssuerModel(int? recordsetCount = default(int?), List<IssuerModel> value = default(List<IssuerModel>), string nextLink = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedQueryResultModelIssuerModel {\n");
