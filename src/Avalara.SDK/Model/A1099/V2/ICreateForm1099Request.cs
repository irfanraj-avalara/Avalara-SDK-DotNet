...
namespace Avalara.SDK.Model.A1099.V2
{
    ...
    public partial class ICreateForm1099Request : AbstractOpenAPISchema, IValidatableObject
    {
        ...
        public ICreateForm1099Request(Form1099KRequest actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public static ICreateForm1099Request FromJson(string jsonString)
        {
            ...
            try
            {
                ...
                {
                    newICreateForm1099Request = new ICreateForm1099Request(JsonConvert.DeserializeObject<Form1099KRequest>(jsonString, ICreateForm1099Request.SerializerSettings));
                }
                else
                {
                    newICreateForm1099Request = new ICreateForm1099Request(JsonConvert.DeserializeObject<Form1099KRequest>(jsonString, ICreateForm1099Request.AdditionalPropertiesSerializerSettings));
                }
