...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "Form1099BaseModel_postalMailStatus")]
    public partial class Form1099BaseModelPostalMailStatus : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Form1099BaseModelPostalMailStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">status.</param>
        public Form1099BaseModelPostalMailStatus(DateTime date = default(DateTime), StatusEnum? status = default(StatusEnum?))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        /// <example>2025-01-22T15:19:42Z</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Form1099BaseModelPostalMailStatus {\n");
