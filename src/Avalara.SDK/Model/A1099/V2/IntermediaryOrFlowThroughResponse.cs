...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "IntermediaryOrFlowThroughResponse")]
    public partial class IntermediaryOrFlowThroughResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IntermediaryOrFlowThroughResponse" /> class.
        /// </summary>
        ...
        public IntermediaryOrFlowThroughResponse(string ein = default(string), string chap3StatusCode = default(string), string chap4StatusCode = default(string), string name = default(string), string giin = default(string), string countryCode = default(string), string foreignTin = default(string), string address = default(string), string city = default(string), string state = default(string), string zip = default(string))
        {
            this.Ein = ein;
