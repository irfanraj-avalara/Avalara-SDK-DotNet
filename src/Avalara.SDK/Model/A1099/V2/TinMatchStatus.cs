...
/// <summary>
    /// TinMatchStatus
    /// </summary>
    [DataContract(Name = "tinMatchStatus")]
    public partial class TinMatchStatus : IValidatableObject
    {
        /// <summary>
        /// The status of TIN matching.
        /// </summary>
        /// <value>The status of TIN matching.</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TinMatchStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">The status of TIN matching..</param>
        public TinMatchStatus(DateTime date = default(DateTime), StatusEnum? status = default(StatusEnum?))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TinMatchStatus {\n");
