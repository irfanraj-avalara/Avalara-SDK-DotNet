...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "Form1099BaseModel_federalEfileStatus")]
    public partial class Form1099BaseModelFederalEfileStatus : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Form1099BaseModelFederalEfileStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">status.</param>
        public Form1099BaseModelFederalEfileStatus(DateTime date = default(DateTime), StatusEnum? status = default(StatusEnum?))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class Form1099BaseModelFederalEfileStatus {\n");
