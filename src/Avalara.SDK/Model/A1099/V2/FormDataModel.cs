...
{
    /// <summary>
    /// A form data payload which can be one of several supported form types.
    /// </summary>
    [JsonConverter(typeof(FormDataModelJsonConverter))]
    [DataContract(Name = "FormDataModel")]
    public partial class FormDataModel : AbstractOpenAPISchema, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormDataModel" /> class
        /// with the <see cref="W4FormDataModel" /> class
        /// </summary>
        /// <param name="actualInstance">An instance of W4FormDataModel.</param>
        public FormDataModel(W4FormDataModel actualInstance)
        {
        ...
        public FormDataModel(W8BeneFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public FormDataModel(W8BenFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public FormDataModel(W8ImyFormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        public FormDataModel(W9FormDataModel actualInstance)
        {
            this.IsNullable = false;
            this.SchemaType= "oneOf";
            this.ActualInstance = actualInstance ?? throw new ArgumentException("Invalid instance found. Must not be null.");
        ...
        {
            return JsonConvert.SerializeObject(this.ActualInstance, FormDataModel.SerializerSettings);
        }

        /// <summary>
        /// Converts the JSON string into an instance of FormDataModel
        /// </summary>
        /// <param name="jsonString">JSON string</param>
        /// <returns>An instance of FormDataModel</returns>
        public static FormDataModel FromJson(string jsonString)
        {
            FormDataModel newFormDataModel = null;
            ...
            try
            {
                ...
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W4FormDataModel>(jsonString, FormDataModel.SerializerSettings));
                }
                else
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W4FormDataModel>(jsonString, FormDataModel.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8BenFormDataModel>(jsonString, FormDataModel.SerializerSettings));
                }
                else
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8BenFormDataModel>(jsonString, FormDataModel.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8BeneFormDataModel>(jsonString, FormDataModel.SerializerSettings));
                }
                else
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8BeneFormDataModel>(jsonString, FormDataModel.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8ImyFormDataModel>(jsonString, FormDataModel.SerializerSettings));
                }
                else
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W8ImyFormDataModel>(jsonString, FormDataModel.AdditionalPropertiesSerializerSettings));
                }
            ...
            try
            {
                ...
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W9FormDataModel>(jsonString, FormDataModel.SerializerSettings));
                }
                else
                {
                    newFormDataModel = new FormDataModel(JsonConvert.DeserializeObject<W9FormDataModel>(jsonString, FormDataModel.AdditionalPropertiesSerializerSettings));
                }
    ...
    /// <summary>
    /// Custom JSON converter for FormDataModel
    /// </summary>
    public class FormDataModelJsonConverter : JsonConverter
    {
        /// <summary>
        ...
        {
            writer.WriteRawValue((string)(typeof(FormDataModel).GetMethod("ToJson").Invoke(value, null)));
        }
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            switch(reader.TokenType) 
            {
                case JsonToken.StartObject:
                    return FormDataModel.FromJson(JObject.Load(reader).ToString(Formatting.None));
                case JsonToken.StartArray:
                    return FormDataModel.FromJson(JArray.Load(reader).ToString(Formatting.None));
                default:
                    return null;
            }
        }
