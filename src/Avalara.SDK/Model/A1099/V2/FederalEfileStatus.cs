...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "federalEfileStatus")]
    public partial class FederalEfileStatus : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FederalEfileStatus" /> class.
        /// </summary>
        /// <param name="date">Date time when the status was set.</param>
        /// <param name="status">status.</param>
        public FederalEfileStatus(DateTime date = default(DateTime), StatusEnum? status = default(StatusEnum?))
        {
            this.Date = date;
            this.Status = status;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FederalEfileStatus {\n");
