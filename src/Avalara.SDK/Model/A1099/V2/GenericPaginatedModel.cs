...
{
/// <summary>
    /// GenericPaginatedModel
    /// </summary>
    [DataContract(Name = "GenericPaginatedModel")]
    public partial class GenericPaginatedModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GenericPaginatedModel" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="nextLink">nextLink.</param>
        /// <param name="value">value.</param>
        public GenericPaginatedModel(decimal recordsetCount = default(decimal), string nextLink = default(string), List<Object> value = default(List<Object>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenericPaginatedModel {\n");
