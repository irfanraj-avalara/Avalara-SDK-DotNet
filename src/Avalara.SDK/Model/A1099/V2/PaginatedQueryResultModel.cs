...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "PaginatedQueryResultModel_")]
    public partial class PaginatedQueryResultModel : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedQueryResultModel" /> class.
        /// </summary>
        /// <param name="recordsetCount">recordsetCount.</param>
        /// <param name="value">value.</param>
        /// <param name="nextLink">nextLink.</param>
        public PaginatedQueryResultModel(int? recordsetCount = default(int?), List<Object> value = default(List<Object>), string nextLink = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedQueryResultModel {\n");
