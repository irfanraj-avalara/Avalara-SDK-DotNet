...
/// <summary>
    ...
    public partial class W4FormDataModel : IValidatableObject
    {
        ...
        public W4FormDataModel(DateTime? signedDate = default(DateTime?), bool? archived = default(bool?), string referenceId = default(string), int? companyId = default(int?), DateTime? createdAt = default(DateTime?), DateTime? updatedAt = default(DateTime?), string displayName = default(string), string email = default(string), string employeeFirstName = default(string), string employeeMiddleName = default(string), string employeeLastName = default(string), string employeeNameSuffix = default(string), string address = default(string), string city = default(string), string state = default(string), string zip = default(string), string tin = default(string), string box3MaritalStatus = default(string), bool? box4LastNameDiffers = default(bool?), int? box5NumAllowances = default(int?), int? otherDependents = default(int?), double? nonJobIncome = default(double?), double? deductions = default(double?), double? box6AdditionalWithheld = default(double?), bool? box7ExemptFromWithholding = default(bool?), string officeCode = default(string), DateTime? eDeliveryConsentedAt = default(DateTime?), int id = default(int), string entryStatus = default(string))
        {
        ...
        /// <example>2022-05-01T12:00Z</example>
        ...
        /// <example>janesmith@example.com</example>
