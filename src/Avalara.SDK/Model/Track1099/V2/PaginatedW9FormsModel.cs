...
/// <summary>
    ...
    public partial class PaginatedW9FormsModel : IValidatableObject
    {
        ...
        public PaginatedW9FormsModel(int recordsetCount = default(int), List<FormDataModel> value = default(List<FormDataModel>), string nextLink = default(string))
        {
        ...
        public List<FormDataModel> Value { get; set; }
