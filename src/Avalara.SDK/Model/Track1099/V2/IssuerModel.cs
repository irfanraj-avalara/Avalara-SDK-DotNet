...
/// <summary>
    ...
    public partial class IssuerModel : IValidatableObject
    {
        ...
        /// <param name="createdAt">Date time when the issuer was created.</param>
        /// <param name="updatedAt">Date time when the issuer was updated.</param>
        /// <param name="userId">id or the manager_id of the user to whom this issuer belongs to.</param>
        public IssuerModel(string name = default(string), string nameDba = default(string), string tin = default(string), string referenceId = default(string), string telephone = default(string), int taxYear = default(int), string countryCode = default(string), string email = default(string), string address = default(string), string city = default(string), string state = default(string), string zip = default(string), string foreignProvince = default(string), long id = default(long), DateTime createdAt = default(DateTime), DateTime updatedAt = default(DateTime), long userId = default(long))
        {
        ...
        [DataMember(Name = "name_dba", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "tax_year", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "foreign_province", EmitDefaultValue = true)]
