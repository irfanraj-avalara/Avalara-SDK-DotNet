...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "DocumentFetchRequest_metadata")]
    public partial class DocumentFetchRequestMetadata : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFetchRequestMetadata" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DocumentFetchRequestMetadata() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DocumentFetchRequestMetadata" /> class.
        /// </summary>
        ...
        public DocumentFetchRequestMetadata(string workflowId = default(string), string dataFormat = default(string), decimal dataFormatVersion = default(decimal), string countryCode = default(string), string countryMandate = default(string))
        {
            // to ensure "workflowId" is required (not null)
            if (workflowId == null)
            {
                throw new ArgumentNullException("workflowId is a required property for DocumentFetchRequestMetadata and cannot be null");
            }
            this.WorkflowId = workflowId;
            // to ensure "dataFormat" is required (not null)
            if (dataFormat == null)
            {
                throw new ArgumentNullException("dataFormat is a required property for DocumentFetchRequestMetadata and cannot be null");
            }
            ...
            if (countryCode == null)
            {
                throw new ArgumentNullException("countryCode is a required property for DocumentFetchRequestMetadata and cannot be null");
            }
            this.CountryCode = countryCode;
            // to ensure "countryMandate" is required (not null)
            if (countryMandate == null)
            {
                throw new ArgumentNullException("countryMandate is a required property for DocumentFetchRequestMetadata and cannot be null");
            }
