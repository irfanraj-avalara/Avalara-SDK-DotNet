...
/// <summary>
    ...
    public partial class DirectorySearchResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DirectorySearchResponse" /> class.
        /// </summary>
        /// <param name="recordSetCount">The count of records in the result set.</param>
        /// <param name="nextLink">The next page link to get the next set of results..</param>
        /// <param name="value">value.</param>
        public DirectorySearchResponse(int recordSetCount = default(int), string nextLink = default(string), List<DirectorySearchResponseValueInner> value = default(List<DirectorySearchResponseValueInner>))
        {
        ...
        public List<DirectorySearchResponseValueInner> Value { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DirectorySearchResponse {\n");
