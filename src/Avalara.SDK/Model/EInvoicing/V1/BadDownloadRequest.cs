...
namespace Avalara.SDK.Model.EInvoicing.V1
{
    ...
    public partial class BadDownloadRequest :  IEquatable<BadDownloadRequest>
    {
        ...
        /// </summary>
        /// <param name="error">The three-digit HTTP error code for the bad request.</param>
        /// <param name="message">A message explaining the bad request.</param>
        /// <param name="supportedAcceptHeaders">A message explaining the bad request.</param>
        public BadDownloadRequest(string error = default(string), string message = default(string), Object supportedAcceptHeaders = default(Object))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SupportedAcceptHeaders: ").Append(SupportedAcceptHeaders).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
