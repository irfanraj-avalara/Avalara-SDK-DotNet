...
/// <summary>
    ...
    /// </summary>
    [DataContract(Name = "SearchParticipants_200_response")]
    public partial class SearchParticipants200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SearchParticipants200Response" /> class.
        /// </summary>
        ...
        public SearchParticipants200Response(int recordSetCount = default(int), string nextLink = default(string), List<TradingPartner> value = default(List<TradingPartner>))
        {
        ...
        public List<TradingPartner> Value { get; set; }
