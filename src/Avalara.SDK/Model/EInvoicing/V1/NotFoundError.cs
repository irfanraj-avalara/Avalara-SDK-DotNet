...
namespace Avalara.SDK.Model.EInvoicing.V1
{
    ...
    public partial class NotFoundError :  IEquatable<NotFoundError>
    {
        ...
        /// </summary>
        /// <param name="error">The three-digit HTTP error code for a not found error.</param>
        /// <param name="message">A message about the not found error.</param>
        public NotFoundError(string error = default(string), string message = default(string))
        {
            this.Error = error;
