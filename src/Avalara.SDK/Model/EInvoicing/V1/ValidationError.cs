...
/// <summary>
    ...
    public partial class ValidationError : IValidatableObject
    {
        ...
        /// <param name="message">A human-readable explanation of the error for the specific field..</param>
        public ValidationError(string field = default(string), string message = default(string))
        {
            this.Field = field;
        ...
        /// </summary>
        /// <value>A human-readable explanation of the error for the specific field.</value>
