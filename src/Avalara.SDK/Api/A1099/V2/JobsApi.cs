...
namespace Avalara.SDK.Api.A1099.V2
{
    ...
    public interface IJobsApiSync 
    {
        ...
        JobModel GetJob(GetJobRequestSdk requestParameters);
    ...
    public interface IJobsApiAsync 
    {
        ...
        System.Threading.Tasks.Task<JobModel> GetJobAsync(GetJobRequestSdk requestParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class JobsApi : IJobsApiSync, IJobsApiAsync
    {
        ...
        /// <param name="requestParameters">Request Object for the API</param>
        /// <returns>JobModel</returns>
        public JobModel GetJob(GetJobRequestSdk requestParameters)
        {
        ...
        private Avalara.SDK.Client.ApiResponse<JobModel> GetJobWithHttpInfo(GetJobRequestSdk requestParameters)
        {
            //OAuth2 Scopes
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of JobModel</returns>
        public async System.Threading.Tasks.Task<JobModel> GetJobAsync(GetJobRequestSdk requestParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        private async System.Threading.Tasks.Task<Avalara.SDK.Client.ApiResponse<JobModel>> GetJobWithHttpInfoAsync(GetJobRequestSdk requestParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            //OAuth2 Scopes
            String requiredScopes = "";
