...
namespace Avalara.SDK.Api.A1099.V2
{
    ...
    public partial class FormRequestsApi : IFormRequestsApiSync, IFormRequestsApiAsync
    {
        ...
        /// <summary>
        /// Get form request Create a W-9, W-8BEN or W-8BEN-E form request for the given &#x60;company_id&#x60; (ID of a company in the W-9 section of the 1099 app) and your internal &#x60;reference_id&#x60; for the vendor. &#x60;reference_id&#x60; is opaque to 1099 but should be meaningful to you. If provided, it must uniquely identify (to you) the person or company from whom you are requesting the form.
        /// </summary>
        /// <exception cref="Avalara.SDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="requestParameters">Request Object for the API</param>
        /// <returns>FormRequestModel</returns>
        ...
        private Avalara.SDK.Client.ApiResponse<FormRequestModel> FormRequestsFormRequestIdGetWithHttpInfo(FormRequestsFormRequestIdGetRequest requestParameters)
        {
            ...
            var localVarResponse = this.Client.Get<FormRequestModel>("/form-requests/{formRequestId}", localVarRequestOptions, requiredScopes, AvalaraMicroservice.A1099);
        ...
        private async System.Threading.Tasks.Task<Avalara.SDK.Client.ApiResponse<FormRequestModel>> FormRequestsFormRequestIdGetWithHttpInfoAsync(FormRequestsFormRequestIdGetRequest requestParameters, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            // make the HTTP request
			var localVarResponse = await this.Client.GetAsync<FormRequestModel>("/form-requests/{formRequestId}", localVarRequestOptions, cancellationToken, requiredScopes, AvalaraMicroservice.A1099).ConfigureAwait(false);
